...
$subname = $_GET['phpsubname'];
$submeetid = $_GET['phpsubmeetid'];

$acc = ServiceAccount::fromJsonFile(__DIR__.'/secret/<Name of Firebase secret JSON file inside secret folder>');
$firebase = (new Factory)->withServiceAccount($acc)->create();
$database = $firebase->getDatabase();
$reference = $database->getReference('/Rooms/'.$submeetid.'/Moderator/SessionID');
$sessionId = $reference->getSnapshot()->getValue();

$token = $opentok->generateToken($sessionId, array('role' => Role::PUBLISHER));

// Updated data entry logic

$loc = $database->getReference('/Rooms/'.$submeetid.'/Panelists/')->push();
$subid = $loc->getKey();
$loc->set(array('APIKey' => $apiKey, 'SessionID' => $sessionId, 'Token' => $token,'Name'=>$subname, 'id'=>$subid));


//echo($subid);

$subdetails = json_encode(array('Name' => $subname, 'ID' => $subid, 'MeetingID' => $submeetid, 'UserRole'=> 'Panelists'));
...
<!--<html> // Original Code. Do not touch.
    ...
    <body>
        ...
        <div id="footer">
            <div id="ed">                
                <button onClick="javascript:buttoncall();"> <img src="media/NoVideo.png" height="40px" width="40px"> </button>
                <button onClick="javascript:raiseHand();"> <img src="media/RaiseHand.png" height="40px" width="40px"> </button>
                <button onClick="javascript:endCall();"> <img src="media/EndCall.png" height="40px" width="40px"> </button>
            </div>
        </div>
            ...
            <div class="row row-height">
                ...
                <div class="x col-lg-12 content-left rounded border border-danger">
                    ...
                    <div class="content-left-wrapper">
                        ...
                        <script type="text/javascript"> 
                            var subdata = <?php echo json_encode($subdetails); ?>; 
                        </script>
                        <script type="text/javascript" src="js/ClientJS.js"></script>
                ...
                <div id="footer">
                    <div id="ed">   
                        ...
                        <button class="btn btn-danger btn-circle" style="background-image:url(media/RaiseHand.png); background-repeat: no-repeat; height:50px; width:50px;" onClick="javascript:raiseHand();"> <!--<img src="media/RaiseHand.png" style="height:40px; width:40px;">--> </button>
                        <button class="btn btn-danger btn-circle" style="background-image:url(media/EndCall.png); background-repeat: no-repeat; height:50px; width:50px;" onClick="javascript:endCall();"> <!--<img src="media/EndCall.png" style="height:40px; width:40px;">--> </button>   
